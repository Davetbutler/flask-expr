...
video_put_args.add_argument("likes", type=int, help="Number of likes of video", required=True)
video_put_args.add_argument("views", type=int, help="Number of likes on video", required=True)
...
class Video(Resource):
    ...
    def get(self, video_id):
        ...
        if not result:
            abort(404, message="could not find video with this video_id")
        return result
